    ...
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      ...
      <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
        <li className="mr-5 text-xs">
          <a href="mailto:your-email@example.com" className="block hover:text-white" target="_blank" rel="noopener noreferrer" aria-label="Email (opens in a new tab)">
        ...
        <li className="mr-5 text-xs">
          <a href="https://github.com/your-github" className="block hover:text-white" target="_blank" rel="noopener noreferrer" aria-label="GitHub (opens in a new tab)">
        ...
        <li className="mr-5 text-xs">
          <a href="https://linkedin.com/in/your-linkedin" className="block hover:text-white" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn (opens in a new tab)">
